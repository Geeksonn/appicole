...
export default function TabsLayout() {
    return (
        <NativeTabs
            ...
            <NativeTabs.Trigger contentStyle={{ backgroundColor: '#FAFAFA' }} name='index'>
                <NativeTabs.Trigger.Label>Accueil</NativeTabs.Trigger.Label>
                <NativeTabs.Trigger.Icon sf='house.fill' md='home' />
            </NativeTabs.Trigger>

            <NativeTabs.Trigger contentStyle={{ backgroundColor: '#FAFAFA' }} name='menu'>
                <NativeTabs.Trigger.Label>La Carte</NativeTabs.Trigger.Label>
                <NativeTabs.Trigger.Icon sf='menucard' md='menu' />
            </NativeTabs.Trigger>

            <NativeTabs.Trigger contentStyle={{ backgroundColor: '#FAFAFA' }} name='planning'>
            ...
            <NativeTabs.Trigger contentStyle={{ backgroundColor: '#FAFAFA' }} name='guide'>
            ...
            <NativeTabs.Trigger contentStyle={{ backgroundColor: '#FAFAFA' }} name='profile'>
